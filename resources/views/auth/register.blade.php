...
@section('content')
    ...
    <main class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="auth-container max-w-md w-full space-y-6 p-10 bg-white rounded-xl shadow-lg">
            ...
            <!-- Signup Form -->
            <form class="mt-6 space-y-5" action="{{route('register.post')}}" method="POST" id="signupForm">
                <!-- Name Input -->
                 @csrf
                <div>
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="{{route('login.get')}}" class="font-medium text-blue-600 hover:text-blue-500">Sign in</a>
                </p>
            </div>
        </div>
    </main>
