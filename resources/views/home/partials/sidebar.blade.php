 <aside class="lg:w-1/3 space-y-8">
            ...
            <div class="bg-white p-6 rounded-lg shadow">
                ...
                <div class="space-y-2">
                    <a href="{{route('home.DevOps')}}" class="flex justify-between items-center p-2 hover:bg-gray-100 rounded-md transition">
                        <span class="text-gray-700">Web Development</span>
                        <span class="bg-gray-200 text-gray-700 text-xs px-2 py-1 rounded-full">12</span>
                    </a>
                    <a href="{{route('home.cyberSe')}}" class="flex justify-between items-center p-2 hover:bg-gray-100 rounded-md transition">
                    ...
                    <a href="{{route('home.cloudComp')}}" class="flex justify-between items-center p-2 hover:bg-gray-100 rounded-md transition">
                    ...
                    <a href="{{route('home.MobDev')}}" class="flex justify-between items-center p-2 hover:bg-gray-100 rounded-md transition">
