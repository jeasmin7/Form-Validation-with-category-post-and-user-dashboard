        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <div class="max-w-sm mx-auto overflow-hidden items-center">
                    <form action="<?php echo e(route('profile.picture')); ?>" method="POST" enctype="multipart/form-data" class="px-4 py-6">
                        <?php echo csrf_field(); ?>
...
</script><?php /**PATH E:\php_laravel_interactive\assignment\UserBlog\resources\views/components/avatar.blade.php ENDPATH**/ ?>