...
<?php $__env->startSection('content'); ?>
    ...
    <main class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="auth-container max-w-md w-full space-y-6 p-10 bg-white rounded-xl shadow-lg">
            ...
            <!-- Signup Form -->
            <form class="mt-6 space-y-5" action="<?php echo e(route('register.post')); ?>" method="POST" id="signupForm">
                <!-- Name Input -->
                 <?php echo csrf_field(); ?>
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="name" name="name" type="text" autocomplete="name" required
                            ...
                            <p class="text-red-500 text-xs italic mt-2"><?php echo e($errors->first('name')); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="email" name="email" type="email" autocomplete="email" required
                            ...
                            <p class="text-red-500 text-xs italic mt-2"><?php echo e($errors->first('email')); ?></p>
                        <?php endif; ?>
                    </div>
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="<?php echo e(route('login.get')); ?>" class="font-medium text-blue-600 hover:text-blue-500">Sign in</a>
                </p>
            </div>
        </div>
    </main>
...
<?php echo $__env->make('home.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\php_laravel_interactive\assignment\UserBlog\resources\views/auth/register.blade.php ENDPATH**/ ?>