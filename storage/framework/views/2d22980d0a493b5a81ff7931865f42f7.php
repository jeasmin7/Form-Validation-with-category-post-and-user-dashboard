...
<div class="mb-6">
   <div class="text-2xl  text-gray-400 dark:text-gray-500" id="bio-text">
                        <form class="w-full " id="bio-form" method="POST" action="<?php echo e(route('profile.bioUpdate')); ?>">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH E:\php_laravel_interactive\assignment\UserBlog\resources\views/profile/editBio.blade.php ENDPATH**/ ?>