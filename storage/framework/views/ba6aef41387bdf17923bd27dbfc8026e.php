                                    ...
                                    <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr
                                            ...
                                            <td class="px-6 py-4 flex gap-2">
                                                <form action="<?php echo e(route('posts.delete', $post->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('DELETE'); ?>
                                                    <button type="submit"
                                                        class="text-white font-medium bg-red-500 px-4 py-2 rounded">Delete</button>
                                                </form>
                                                <a href="<?php echo e(route('posts.edit.get', $post->id)); ?>"
...
<?php endif; ?>
<?php /**PATH E:\php_laravel_interactive\assignment\UserBlog\resources\views/posts/index.blade.php ENDPATH**/ ?>