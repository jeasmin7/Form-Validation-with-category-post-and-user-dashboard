        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition">
                    <img src="<?php echo e(asset('assets/images/web.jpg')); ?>" alt="Web Development" class="w-full h-48 object-cover">
                    <div class="p-6">
                        ...
                        <a href="<?php echo e(route('posts.index')); ?>" class="text-blue-600 font-medium hover:text-blue-800 transition">Read More</a>
                    </div>
                </div>
                
                <!-- Featured Post 2 -->
                <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition">
                    <img src="<?php echo e(asset('assets/images/web2.jpg')); ?>" alt="Artificial Intelligence" class="w-full h-48 object-cover">
                    <div class="p-6">
                        <div class="flex items-center text-sm text-gray-500 mb-2">
                ...
                <!-- Featured Post 3 -->
                <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition">
                    <img src="<?php echo e(asset('assets/images/web3.jpg')); ?>" alt="Cloud Computing" class="w-full h-48 object-cover">
                    <div class="p-6">
                        <div class="flex items-center text-sm text-gray-500 mb-2">
        ...
        <main class="lg:w-2/3">
            ...
            <div class="space-y-8">
                ...
                <article class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition flex flex-col md:flex-row">
                    <img src="<?php echo e(asset('assets/images/web4.jpg')); ?>" alt="React 18" class="md:w-1/3 h-48 md:h-auto object-cover">
                ...
                <!-- Recent Post 2 -->
                <article class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition flex flex-col md:flex-row">
                    <img src="<?php echo e(asset('assets/images/web5.jpg')); ?>" alt="Cybersecurity" class="md:w-1/3 h-48 md:h-auto object-cover">
                    <div class="p-6 md:w-2/3">
                        <div class="flex items-center text-sm text-gray-500 mb-2">
                ...
                <!-- Recent Post 3 -->
                <article class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition flex flex-col md:flex-row">
                    <img src="<?php echo e(asset('assets/images/web6.jpg')); ?>" alt="Low-Code Development" class="md:w-1/3 h-48 md:h-auto object-cover">
                    <div class="p-6 md:w-2/3">
                        <div class="flex items-center text-sm text-gray-500 mb-2">
...
<?php echo $__env->make('home.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\php_laravel_interactive\assignment\UserBlog\resources\views/index.blade.php ENDPATH**/ ?>