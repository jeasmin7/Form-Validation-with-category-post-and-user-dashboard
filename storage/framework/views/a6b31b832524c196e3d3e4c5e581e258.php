        <aside class="bg-gray-800 text-white flex-shrink-0 w-64 relative z-10 flex flex-col" id="sidebar">
            ...
            <div class="flex-grow px-2 py-4 overflow-y-auto">
                <nav class="flex-1 space-y-1">
                    <div>
                        <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center px-3 py-3 text-sm font-medium rounded-md bg-gray-900 text-white">
                    ...
                    <?php if(auth()->user()->role ==='admin'): ?>
                            ...
                            <a href="<?php echo e(route('categories.create.get')); ?>" class="flex items-center px-3 py-2 text-sm rounded-md text-gray-300 hover:bg-gray-700 hover:text-white pl-11">
                                <i class="fas fa-pen mr-3 text-xs"></i>
                                <span>Create Category</span>
                            </a>
                            <a href="<?php echo e(route('categories.show')); ?>" class="flex items-center px-3 py-2 text-sm rounded-md text-gray-300 hover:bg-gray-700 hover:text-white pl-11">
                                <i class="fas fa-pen mr-3 text-xs"></i>
                                <span>Category List</span>
                            </a>
                         <?php endif; ?>
                            <a href="<?php echo e(route('dashboard.posts')); ?>" class="flex items-center px-3 py-2 text-sm rounded-md text-gray-300 hover:bg-gray-700 hover:text-white pl-11">
                 ...
                 <div>
                    ...
                    <div class="sidebar-dropdown">
                        ...
                        <path
                            ...
                            <a href="<?php echo e(route('profile')); ?>" class="flex items-center px-3 py-2 text-sm rounded-md text-gray-300 hover:bg-gray-700 hover:text-white pl-11">
...
<?php /**PATH E:\php_laravel_interactive\assignment\UserBlog\resources\views/dashboard/sidebar.blade.php ENDPATH**/ ?>