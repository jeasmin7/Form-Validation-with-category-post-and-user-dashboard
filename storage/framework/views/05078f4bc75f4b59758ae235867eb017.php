           ...
           <div class="grid  gap-4 mb-4">
                    <div class="flex items-center justify-center  rounded-sm bg-gray-50 dark:bg-gray-800">
                        <div class="text-2xl text-green-600 dark:text-green-600">
                            ...
                            <form method="POST" action="<?php echo e(route('categories.edit.post', $category)); ?>">
                                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH E:\php_laravel_interactive\assignment\UserBlog\resources\views/categories/edit.blade.php ENDPATH**/ ?>